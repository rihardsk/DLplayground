...
%{
images = loadMNISTImages([datadir, 't10k-images-idx3-ubyte.gz']);
labels = loadMNISTLabels([datadir, 't10k-labels-idx1-ubyte.gz']);
labels(labels==0) = 10; % Remap 0 to 10
pred = ones(size(labels)) * 2;
displayWrong(images, labels, pred);
...
images = loadMNISTImages([datadir, 'train-images-idx3-ubyte.gz']);
labels = loadMNISTLabels([datadir,  'train-labels-idx1-ubyte.gz']);
labels(labels==0) = 10; % Remap 0 to 10
