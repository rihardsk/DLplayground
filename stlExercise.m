...
mnistData = loadMNISTImages([datadir, 'train-images-idx3-ubyte.gz']);
mnistLabels = loadMNISTLabels([datadir,  'train-labels-idx1-ubyte.gz']);
...
displayWrong(testData, testLabels(:) - 1, pred(:) - 1);